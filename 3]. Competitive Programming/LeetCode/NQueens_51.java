...
class NQueens_51 {
    ...
    private static void solveNQueensHelper(int[][] board, int row, ArrayList<String> list, List<List<String>> result) {
        if(row == board.length) {
    ...
    private static String getQueenPosition(int stringLength, int queenPosition) {
